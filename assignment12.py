...
import webbrowser
print("youtube song video (song name:->Teri Meri Tutju)")
webbrowser.open_new_tab("https://www.youtube.com/watch?v=cnffodDjBSA&start_radio=1&list=RDMMcnffodDjBSA")
print()

#Question3:-> Write a program to rename all the files in a directory and convert them into .jpg file format.
import os,sys
folder = r'C:\Users\chira\Desktop\New folder (5)'
